...
class Checkout extends Component {
	...
	this.setState({
	  ...
	  get_alamat = () => {
	    ...
	    let url = "http://localhost:3000/toko_online/public/alamat/"+id;
	    axios.get(url)
	    .then(response => {
	      this.setState({
		...
		<div className="container">
			...
			<div className="row">
						...
						<tbody>
							{carts.map((product, index) =>
								<tr key={index}>
									...
									<td>
										<h5><span className="secondary">{product.quantity}</span></h5>
									</td>
									<td>
										<h5>
				...
				<div className="col-md-8 order-md-1">
					<h4 className="mb-3">Pilih Alamat Pengiriman yang Akan Dituju</h4>
